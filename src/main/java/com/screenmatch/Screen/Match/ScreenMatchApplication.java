...
public class ScreenMatchApplication implements CommandLineRunner {
	...
	public void run(String...args) throws Exception {
		...
		var json = apiFilmes.obterDados("http://www.omdbapi.com/?t=Star+Wars%3A+Episode+IV+-+A+New+Hope&apikey=6c5f82fc");
		// Conversor
		...
		System.out.printf("Titulo do filme: %s e seu lancamento foi em ", dadosSerie.title(), dadosSerie.year());
	}
}
